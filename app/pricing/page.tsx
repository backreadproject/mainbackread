...
const COPY: Record<"en" | "fr", Copy> = {
  en: {
    ...
    tiers: [
      { id: "free", name: "Free", price: "$0", period: "to try it", audience: "For a first look", tagline: "A taste of the real thing. Not enough to run on.", cta: "Start free", href: "/login?signup=1&plan=free",
      ...
      { id: "personal", name: "Personal", price: "$20", period: "per month", audience: "Founders, freelancers, solo sellers", tagline: "Everything, for one person who closes.", cta: "Choose Personal", href: "/login?signup=1&plan=personal", popular: true, includes: "Everything in Free, plus",
      ...
      { id: "team", name: "Team", price: "$59", period: "per month", audience: "Sales and deal teams", tagline: "Your whole team, reading together.", cta: "Start 7-day trial", href: "/login?signup=1&plan=team", includes: "Everything in Personal, plus",
      ...
      { id: "business", name: "Business", price: "$99", period: "per month", audience: "Companies that need control", tagline: "Unlimited seats, fully locked down.", cta: "Start 7-day trial", href: "/login?signup=1&plan=business", includes: "Everything in Team, plus",
  ...
  fr: {
    ...
    tiers: [
      { id: "free", name: "Gratuit", price: "0 $", period: "pour essayer", audience: "Pour un premier aper\u00e7u", tagline: "Un aper\u00e7u du produit r\u00e9el. Pas assez pour travailler.", cta: "Commencer gratuitement", href: "/login?signup=1&plan=free",
      ...
      { id: "personal", name: "Personnel", price: "20 $", period: "par mois", audience: "Fondateurs, ind\u00e9pendants, vendeurs solo", tagline: "Tout, pour une personne qui conclut.", cta: "Choisir Personnel", href: "/login?signup=1&plan=personal", popular: true, includes: "Tout ce qu'il y a dans Gratuit, plus",
      ...
      { id: "team", name: "\u00c9quipe", price: "59 $", period: "par mois", audience: "\u00c9quipes de vente", tagline: "Toute votre \u00e9quipe, qui lit ensemble.", cta: "Essai gratuit de 7 jours", href: "/login?signup=1&plan=team", includes: "Tout ce qu'il y a dans Personnel, plus",
      ...
      { id: "business", name: "Entreprise", price: "99 $", period: "par mois", audience: "Entreprises qui exigent le contr\u00f4le", tagline: "Si\u00e8ges illimit\u00e9s, parfaitement verrouill\u00e9.", cta: "Essai gratuit de 7 jours", href: "/login?signup=1&plan=business", includes: "Tout ce qu'il y a dans \u00c9quipe, plus",

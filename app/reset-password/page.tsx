  ...
  return (
    <div style={{ minHeight: "100vh", background: CANVAS, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: DM, color: INK, padding: "24px 16px", boxSizing: "border-box" }}>
      ...
      <div style={{ width: "100%", maxWidth: 360, boxSizing: "border-box", background: CARD, borderRadius: 16, padding: 30, boxShadow: GLOW }}>
        ...
        {done ? (
          <>
            <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.015em", margin: "0 0 8px" }}>Password updated</h1>
            <p style={{ fontSize: 14, color: SLATE, margin: 0 }}>Taking you to your documents...</p>
          </>
        ) : !ready ? (
          <>
            <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.015em", margin: "0 0 8px" }}>Opening your reset link...</h1>
            ...
            <a href="/forgot-password" className="fx-link" style={{ fontSize: 14, color: GREEN, textDecoration: "none", fontWeight: 600 }}>Request a new link</a>
          </>
        ) : (
          <>
            <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.015em", margin: "0 0 4px" }}>Set a new password</h1>

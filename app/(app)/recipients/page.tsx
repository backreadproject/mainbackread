...
export default function RecipientsPage(){
  return (<div style={{fontFamily:AEON,color:INK,minHeight:"100vh"}}>
    <main style={{maxWidth:820,padding:"40px 40px"}}>
      <h1 style={{fontSize:26,fontWeight:400,letterSpacing:"-0.015em",margin:"0 0 24px"}}>Recipients</h1>
      <div style={{background:CARD,borderRadius:14,padding:32,boxShadow:SHADOW}}>
        <p style={{fontSize:15,color:SLATE,margin:0,lineHeight:1.6}}>Recipients tools are coming in the next build.</p>
      </div>
    </main>
  </div>);
}

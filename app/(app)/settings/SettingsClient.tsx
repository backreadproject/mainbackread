...
const INK = "#0B1220", CARD = "#FFFFFF", BLUE = "#2D6BFF", SLATE = "#64748B", LINE = "#E7EBF2", GREEN = "#059669";
  ...
  return (
    <div style={{ fontFamily: INTER, color: INK, minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 580, padding: "40px 40px" }}>
        <h1 style={{ fontSize: 26, fontWeight: 500, letterSpacing: "-0.015em", margin: "0 0 24px" }}>Settings</h1>
        ...
        <div style={card}>
          ...
          <button onClick={save} disabled={busy} className="fx-b" style={{ background: BLUE, color: "#fff", border: "none", borderRadius: 10, padding: "11px 18px", fontSize: 14, fontWeight: 500, fontFamily: INTER, opacity: busy ? 0.5 : 1 }}>

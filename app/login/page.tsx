...
export default function LoginPage() {
  ...
  return (
    <div className="login-grid" style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", fontFamily: T.font, letterSpacing: T.tracking, color: T.body }}>
      <style>{`.t-in:focus{border-color:${T.green};outline:none}.t-cta:hover{background:${T.greenHover}}.t-link:hover{opacity:.7}@media(max-width:820px){.t-hero{display:none!important}.login-grid{grid-template-columns:1fr!important}.login-form-pane{padding:20px 16px!important}}`}</style>

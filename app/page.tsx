...
export default function LandingPage() {
  ...
  const eyebrow = { fontSize: 14, fontWeight: 400, color: BLUE, textTransform: "uppercase" as const, letterSpacing: "0.08em", margin: "0 0 12px" };
    ...
    <div style={{ fontFamily: INTER, color: INK, background: CANVAS, fontWeight: 400 }}>
      ...
      <div style={{ background: NIGHT }}>
        <nav style={{ ...wrap, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 32px" }}>
          <span style={{ color: "#fff", fontSize: 21, fontWeight: 600, letterSpacing: "-0.01em" }}>BackRead</span>
          ...
          <a href="/login" className="lp-a lp-cta" style={{ background: BLUE, color: "#fff", fontSize: 14, fontWeight: 400, padding: "9px 18px", borderRadius: 10, boxShadow: "0 4px 12px rgba(45,107,255,0.3)" }}>Start free</a>
        </nav>
      </div>
      ...
      <section style={{ background: NIGHT, color: "#fff", position: "relative", overflow: "hidden" }}>
        <div style={{ ...wrap, padding: "84px 32px 100px", position: "relative", zIndex: 2 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(45,107,255,0.12)", border: "1px solid rgba(45,107,255,0.3)", color: "#8FB4FF", fontSize: 13, fontWeight: 400, padding: "6px 14px", borderRadius: 20, marginBottom: 28 }}>
            <span style={{ width: 6, height: 6, borderRadius: 9, background: GREEN }} />
            Now in beta — free for early users
          </div>
          <h1 className="lp-h1" style={{ fontSize: 62, fontWeight: 400, lineHeight: 1.05, letterSpacing: "-0.03em", margin: "0 0 24px", maxWidth: 820 }}>
          ...
          <div style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
            <a href="/login" className="lp-a lp-cta" style={{ background: BLUE, color: "#fff", fontSize: 16, fontWeight: 400, padding: "14px 26px", borderRadius: 12, boxShadow: "0 6px 20px rgba(45,107,255,0.35)" }}>Send your first document</a>
      ...
      <section style={{ background: INK, color: "#fff", padding: "26px 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div style={{ ...wrap, display: "flex", alignItems: "center", justifyContent: "center", gap: 40, flexWrap: "wrap" }}>
          ...
          {["Pitch decks", "Sales proposals", "Investor updates", "Statements of work"].map((t) => (
            <span key={t} style={{ fontSize: 15, fontWeight: 400, color: CLOUD }}>{t}</span>
          ))}
        </div>
      </section>
      ...
      <section style={{ background: "#fff", padding: "80px 0", borderTop: `1px solid ${LINE}` }}>
        <div className="lp-row" style={{ ...wrap, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
          ...
          <div style={{ background: CANVAS, borderRadius: 16, border: `1px solid ${LINE}`, padding: 20 }}>
            <div style={{ fontSize: 12, fontWeight: 400, color: BLUE, marginBottom: 14 }}>Ask BackRead</div>
        ...
        <div className="lp-row" style={{ ...wrap, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
          <div style={{ background: CARD, borderRadius: 16, padding: 24, boxShadow: SHADOW }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
              <span style={{ fontSize: 13, fontWeight: 400, color: SLATE }}>Verdict · Sarah at Meridian</span>
      ...
      <section style={{ background: "#fff", padding: "80px 0", borderTop: `1px solid ${LINE}` }}>
        <div className="lp-row" style={{ ...wrap, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
          ...
          <div style={{ background: CANVAS, borderRadius: 16, border: `1px solid ${LINE}`, padding: 20 }}>
            <div style={{ fontSize: 12, fontWeight: 400, color: SLATE, marginBottom: 12 }}>Suggested rewrite · Slide 7</div>
      ...
      <section id="how" style={{ padding: "88px 0" }}>
        <div style={wrap}>
          ...
          <h2 style={{ fontSize: 38, fontWeight: 400, letterSpacing: "-0.02em", margin: "0 0 44px", maxWidth: 560 }}>Three steps from send to signal</h2>
      ...
      <section id="uses" style={{ padding: "88px 0" }}>
        <div style={wrap}>
          ...
          <h2 style={{ fontSize: 38, fontWeight: 400, letterSpacing: "-0.02em", margin: "0 0 44px", maxWidth: 560 }}>Built for every send that actually matters</h2>
      ...
      <section style={{ background: NIGHT, color: "#fff", padding: "96px 0", textAlign: "center" }}>
        <div style={wrap}>
          <h2 style={{ fontSize: 46, fontWeight: 400, letterSpacing: "-0.025em", margin: "0 0 16px" }}>Stop guessing what they thought.</h2>
          <p style={{ fontSize: 19, color: CLOUD, margin: "0 0 32px" }}>Send one document. Read the reader back.</p>
          <a href="/login" className="lp-a lp-cta" style={{ display: "inline-block", background: BLUE, color: "#fff", fontSize: 17, fontWeight: 400, padding: "15px 32px", borderRadius: 12, boxShadow: "0 6px 20px rgba(45,107,255,0.4)" }}>Start free — no card needed</a>
        </div>
      </section>

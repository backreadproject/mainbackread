const NIGHT = "#082019", INK = "#0F1729", CANVAS = "#F8F9FA", CARD = "#FFFFFF", BLUE = "#0B7A4B", BLUE_SOFT = "#E7F6EF", GREEN = "#10B981", GREEN_BG = "#E7F7EF", SLATE = "#475467", MUTE = "#94A3B8", LINE = "#E7EBF2", CLOUD = "rgba(255,255,255,0.72)";
...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: INTER, color: INK, background: CANVAS, fontWeight: 400, overflowX: "hidden" }}>
      <style>{`
        ...
        @media(max-width:560px){
          ...
          .lp-hero-pad{padding:56px 20px 64px!important}
          .lp-sec-pad{padding-top:56px!important;padding-bottom:56px!important}
        }
      `}</style>

      <div style={{ background: NIGHT }}>
        <nav className="lp-pad" style={{ ...wrap, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 32px" }}>

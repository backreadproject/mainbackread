  ...
  return (
    <div style={{ fontFamily: font, color: INK, background: CARD, minHeight: "100vh", letterSpacing: "-0.006em" }}>
      <header style={{ borderBottom: `1px solid ${LINE}`, position: "sticky", top: 0, background: "rgba(255,255,255,0.92)", backdropFilter: "saturate(180%) blur(8px)", zIndex: 10 }}>
        <div className="rl-bar" style={{ maxWidth: 1000, margin: "0 auto", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            {mark(28)}
            <span style={{ fontSize: 18, fontWeight: 700, letterSpacing: "-0.01em" }}>{r.brand}</span>
          </div>
          <div className="rl-navwrap" style={{ display: "flex", alignItems: "center", gap: 22, fontSize: 14, color: BODY }}>
      ...
      <style>{`
        .rl-nav:hover{color:${INK}}
        @media (max-width: 640px){
          /* 40px at -0.025em is about six characters a line on a phone. */
          .rl-hero{ font-size: 28px !important; letter-spacing: -0.018em !important; }
          .rl-lead{ font-size: 15.5px !important; }
          .rl-h2{ font-size: 22px !important; }
          .rl-sub{ font-size: 15px !important; }
          /* Three links plus a wordmark do not share 360px comfortably. */
          .rl-nav{ font-size: 13px !important; }
          .rl-navwrap{ gap: 14px !important; }
          .rl-bar{ padding: 12px 16px !important; }
          .rl-sec{ padding-left: 16px !important; padding-right: 16px !important; }
          .rl-hero-sec{ padding: 44px 16px 40px !important; }
          .rl-cta{ padding: 28px 18px !important; }
          .rl-foot{ flex-direction: column !important; align-items: flex-start !important; gap: 14px !important; }
        }
      `}</style>

      <section style={{ background: CANVAS, borderBottom: `1px solid ${LINE}` }}>
        <div className="rl-hero-sec" style={{ maxWidth: 720, margin: "0 auto", padding: "72px 24px 64px", textAlign: "center" }}>
          ...
          <h1 className="rl-hero" style={{ fontSize: 40, fontWeight: 700, letterSpacing: "-0.025em", lineHeight: 1.12, margin: "0 0 18px" }}>{r.heroTitle}</h1>
          <p className="rl-lead" style={{ fontSize: 17, color: BODY, lineHeight: 1.6, margin: "0 auto 28px", maxWidth: 520 }}>{r.heroBody}</p>
          <div style={{ fontSize: 14, color: MUTE }}>{r.heroNote}</div>
        </div>
      </section>

      <section className="rl-sec" style={{ maxWidth: 1000, margin: "0 auto", padding: "56px 24px" }}>
      ...
      <section id="how" style={{ background: CANVAS, borderTop: `1px solid ${LINE}`, borderBottom: `1px solid ${LINE}` }}>
        <div className="rl-sec" style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px" }}>
          <h2 className="rl-h2" style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em", margin: "0 0 8px", textAlign: "center" }}>{r.howTitle}</h2>
          <p className="rl-sub" style={{ fontSize: 16, color: BODY, textAlign: "center", margin: "0 auto 40px", maxWidth: 480, lineHeight: 1.55 }}>{r.howSubtitle}</p>
      ...
      <section id="security" className="rl-sec" style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px" }}>
        <h2 className="rl-h2" style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em", margin: "0 0 8px", textAlign: "center" }}>{r.secTitle}</h2>
        <p className="rl-sub" style={{ fontSize: 16, color: BODY, textAlign: "center", margin: "0 auto 40px", maxWidth: 520, lineHeight: 1.55 }}>{r.secSubtitle}</p>
      ...
      <section id="faq" style={{ background: CANVAS, borderTop: `1px solid ${LINE}` }}>
        <div className="rl-sec" style={{ maxWidth: 720, margin: "0 auto", padding: "60px 24px" }}>
          <h2 className="rl-h2" style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em", margin: "0 0 28px", textAlign: "center" }}>{r.faqTitle}</h2>
          <div>
            {faq(r.faq1Q, r.faq1A)}
            {faq(r.faq2Q, r.faq2A)}
            {faq(r.faq3Q, r.faq3A)}
      ...
      <section className="rl-sec" style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px", textAlign: "center" }}>
        <div className="rl-cta" style={{ background: GREEN_SOFT, borderRadius: 16, padding: "40px 28px" }}>
          <h2 className="rl-h2" style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.02em", color: INK, margin: "0 0 8px" }}>{r.ctaTitle}</h2>
      ...
      <footer style={{ borderTop: `1px solid ${LINE}` }}>
        <div className="rl-foot" style={{ maxWidth: 1000, margin: "0 auto", padding: "28px 24px", display: "flex", flexWrap: "wrap", gap: 12, alignItems: "center", justifyContent: "space-between" }}>
